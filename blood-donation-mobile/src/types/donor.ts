...
export interface ScreeningAnswers {
  ...
  hadTyphoid: boolean; typhoidDate: string;
  hadMalaria: boolean; malariaDate: string;
  hadDengue: boolean; dengueDate: string;
  hadChikungunya: boolean; chikungunyaDate: string;
  hadZika: boolean; zikaDate: string;
  hadMeaslesMumpsChicken: boolean; measlesDate: string;
  hadKidneyInfection: boolean; kidneyInfectionDate: string;
  hadUTI: boolean; utiDate: string;
  hadCovid19Vaccine: boolean; covid19VaccineDate: string;
  hadLiveVaccine: boolean; liveVaccineDate: string;
  hadAntiRabies: boolean; antiRabiesDate: string;
  hadHepBIg: boolean; hepBIgDate: string;
  ...
  isPregnant: boolean;
  recentDelivery: boolean; deliveryDate: string;
  recentAbortion: boolean; abortionDate: string;
  isLactating: boolean;
